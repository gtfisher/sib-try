...
to get your key see https://account.sendinblue.com/advanced/api

The the code references SEND_IN_BLUE_KEY environment variable that shuold point to your key
